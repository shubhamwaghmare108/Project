...
def reset_function():
    ...
    if passkey==correct_passkey:
        ...
        for i in Result.keys():
            print(i, '\t\t', Result[i])
        print('Results have been reset Successfuly.')

# Operator Control
operations = {1: cast_vote_func, 2: result_summary, 3: reset_function}

while session:
    try:
        Operator_input = int(input('Please choose an operation:\n[1 for vote cast, 2 for summary, 3 for reset, 0 to exit]:\n'))
